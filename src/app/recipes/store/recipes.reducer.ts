    ...
    switch (action.type) {
        ...
        case (RecipeActions.SET_TEST_RECIPES):
            const testRecipes = [{
                ...
                description: "Delicious on burgers, chopped up in salad or just on their own.",
                ingredients: [{ name: 'One Can Black beans' }, { name: 'One diced Onion' }, { name: 'Two Cups Crimini Mushrooms' }, { name: 'One cup blended oat flour' }, { name: 'Four cloves minced Garlic' }, { name: 'One tbsp Montreal Steak Spice' }, { name: 'To tsp oregano' }, { name: 'Two tsp Basil' }, { name: 'One tbsp soy sauce' }, { name: 'Oil for Frying' }],
